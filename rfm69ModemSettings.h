...
#define CONFIG_OOK_FILTER (REG_DATA_MODUL_DATAMODE_PKT | REG_DATA_MODUL_MODULATION_TYPE_OOK  | REG_DATA_MODUL_MODULATION_SHAPING_GAUSS_BT1_0 | REG_DATA_MODUL_MODULATION_SHAPING_NO_SHAPING)

#define CONFIG_NOWHITE_NOCRC (REG_PACKET_CONFIG1_PACKET_FORMAT_VARLEN | REG_PACKET_CONFIG1_DC_FREE_NONE | REG_PACKET_CONFIG1_ADDR_FILTER_NODE_OR_BRDCAST_ADDR)
